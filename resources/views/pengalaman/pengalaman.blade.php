                    ...
                    <div class="card-body">
                        <div class="mb-3 text-end">
                            ...
                            <button class="btn btn-pill btn-primary" type="button" data-bs-toggle="modal"
                                data-bs-target="#exampleModalgetbootstrap" title="Tambah pengalaman">+Tambah
                                pengalaman</button>
                        </div>
                            ...
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    @foreach ($pengalaman as $item)
                                            ...
                                            <td>
                                                <ul class="action">
                                                    <li class="edit" data-bs-toggle="modal"
                                                        data-bs-target="#exampleModalgetbootstrap{{ $item->id_pengalaman }}">
                                                        <a href="#"><i class="icon-pencil-alt"></i></a>
                                                    </li>
                                                    <li class="delete" data-bs-toggle="modal"
                                                        data-bs-target="#modalhapuspengalaman{{ $item->id_pengalaman }}"><a
                                                            href="#"><i class="icon-trash"></i></a></li>
                                                </ul>
                                            </td>
                                        </tr>
                                        {{-- modal hapus 2 --}}
                                        <div class="modal fade" id="modalhapuspengalaman{{ $item->id_pengalaman }}"
                                            tabindex="-1" role="dialog" aria-labelledby="modalTambahpengalamanLabel"
                                            aria-hidden="true">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-toggle-wrapper">
                                                            ...
                                                            <div class="d-flex justify-content-center gap-2">
                                                                ...
                                                                <a href="/hapus/{{ $item->id_pengalaman }}/pengalaman"
                                        ...
                                        {{-- modal edit --}}
                                        <div class="modal fade" id="exampleModalgetbootstrap{{ $item->id_pengalaman }}"
                                            tabindex="-1" aria-labelledby="exampleModalgetbootstrap" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header border-0">
                                                        <h5 class="modal-title mx-auto">Tambah Data pengalaman</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                                    <form action="/edit/{{ $item->id_pengalaman }}/pengalaman"
                                                            ...
                                                            <div class="row g-3">
                                                                <div class="col-md-6">
                                                                    <label for="validationCustom01"
                                                                        class="form-label">Bidang Kerja</label>
                                                                    <input type="text" class="form-control"
                                                                        id="validationCustom01" name="bidang_kerja"
                                                                        value="{{ $item->bidang_kerja }}"
                                                                        placeholder="Masukkan Nama pengalaman..." required>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="validationCustom02" name="perusahaan"
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="3"
                                                                        placeholder="Masukkan Description..." required>{{ $item->desk_pengalaman }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-toggle-wrapper social-profile text-start dark-sign-up">
                    <h3 class="modal-header justify-content-center border-0">Tambah Data pengalaman</h3>
                    <div class="modal-body">
                        <form action="/tambah/pengalaman" method="POST" class="row g-3 needs-validation"
                            novalidate="">
                            @csrf
                            <div class="col-md-6">
                                <label class="form-label" for="validationCustom01">Bidang Kerja</label>
                                <input class="form-control" id="validationCustom01" type="text" name="bidang_kerja"
                                    placeholder="Masukkan Bidang Kerja...." required="">
                                <div class="valid-feedback">Looks good!</div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" for="validationCustom02">Perusahaan</label>
                                <input class="form-control" id="validationCustom02" type="text" name="perusahaan"
                                    placeholder="Masukkan Perusahaan pengalaman...." required="">
                                <div class="valid-feedback">Looks good!</div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="validationCustom02" type="text" name="tahun_keluar"
                                    placeholder="Masukkan Tahun Keluar pengalaman...." required="">
                                <div class="valid-feedback">Looks good!</div>
                            </div>
                            <div class="modal-body">
                                <div class="col-12">
