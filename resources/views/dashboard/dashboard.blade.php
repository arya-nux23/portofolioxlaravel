                            ...
                            <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0">
                                    <div class="icon"><img class="img-fluid"
                                            src="{{ asset('admiro') }}/assets/images/dashboard-3/user/20.png"
                                            alt="chair" /></div>
                                </div>
                    ...
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0">
                                    <div class="icon"><img class="img-fluid"
                                            src="{{ asset('admiro') }}/assets/images/dashboard-3/user/21.png"
                                            alt="chair" /></div>
                                </div>
                                <div class="flex-grow-1">
                    ...
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0">
                                    <div class="icon"><img class="img-fluid"
                                            src="{{ asset('admiro') }}/assets/images/dashboard-3/user/22.png"
                                            alt="chair" /></div>
                                </div>
                                <div class="flex-grow-1">
                                    <h5>Graphic Design</h5>
                ...
                <div class="card upcoming-card">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            ...
                            <div class="dropdown icon-dropdown">
                                <button class="btn" id="userdropdown4" type="button"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i
                                        class="fa-solid fa-ellipsis"></i></button>
                                <div class="dropdown-menu dropdown-menu-end"
                    ...
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            ...
                            <div class="d-flex">
                                ...
                                <ul class="simple-wrapper nav nav-pills" id="myTab"
                                    role="tablist">
                        ...
                        <ul>
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid"
                                        src="{{ asset('admiro') }}/assets/images/dashboard-1/news-update/1.png"
                                        alt="" /></div>
                                <div class="flex-grow-1">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid"
                                        src="{{ asset('admiro') }}/assets/images/dashboard-1/news-update/2.png"
                                        alt="" /></div>
                                <div class="flex-grow-1">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid"
                                        src="{{ asset('admiro') }}/assets/images/dashboard-1/news-update/3.png"
                                        alt="" /></div>
                                <div class="flex-grow-1">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid"
                                        src="{{ asset('admiro') }}/assets/images/dashboard-1/news-update/4.png"
                                        alt="" /></div>
                                <div class="flex-grow-1">
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid"
                                        src="{{ asset('admiro') }}/assets/images/dashboard-1/news-update/5.png"
                                        alt="" /></div>
                                <div class="flex-grow-1">
                                    <h6>Art Now Series Presents Catherine...</h6>
                                    <p class="text-truncate">Wed, Feb 24,2022; 12:00 pm-1:00pm</p>
                            ...
                            <li class="d-flex gap-2">
                                <div class="flex-shrink-0"><img class="img-fluid"
                                        src="{{ asset('admiro') }}/assets/images/dashboard-1/news-update/6.png"
                                        alt="" /></div>
                                <div class="flex-grow-1">
                                    <h6>Virtual STEM Clubs for 4-8 with Destina...</h6>
                                    <p class="text-truncate">Wed, Feb 24,2022; 12:00 pm-1:00pm</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0 details-table">
                        <div class="table-responsive theme-scrollbar">
                            <table class="table display table-bordernone mt-0" id="student-detail"
                                style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Customer</th>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="{{ asset('admiro') }}/assets/images/dashboard-3/user/7.png"
                                                        alt="" /></div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="{{ asset('admiro') }}/assets/images/dashboard-3/user/8.png"
                                                        alt="" /></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h6>Ralph Venter</h6>
                                                    </a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="{{ asset('admiro') }}/assets/images/dashboard-3/user/9.png"
                                                        alt="" /></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h6>Edwin Deo</h6>
                                                    </a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="{{ asset('admiro') }}/assets/images/dashboard-3/user/10.png"
                                                        alt="" /></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h6>Aaron Hors</h6>
                                                    </a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="{{ asset('admiro') }}/assets/images/dashboard-3/user/11.png"
                                                        alt="" /></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h6>Fenter Jessy</h6>
                                                    </a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="{{ asset('admiro') }}/assets/images/dashboard-3/user/12.png"
                                                        alt="" /></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h6>Alice Hogan</h6>
                                                    </a>
                ...
                <div class="card">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            <h3>New Courses</h3>
                            <div class="dropdown icon-dropdown">
                                <button class="btn" id="userdropdown7" type="button"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i
                                        class="fa-solid fa-ellipsis"></i></button>
                                <div class="dropdown-menu dropdown-menu-end"
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0 comman-round">
                                                    <div class="icon"><img class="img-fluid"
                                                            src="{{ asset('admiro') }}/assets/images/dashboard-3/user/13.png"
                                                            alt="chair" /></div>
                                                </div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h5>Gary Goodwin</h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0 comman-round">
                                                    <div class="icon"><img class="img-fluid"
                                                            src="{{ asset('admiro') }}/assets/images/dashboard-3/user/14.png"
                                                            alt="chair" /></div>
                                                </div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h5>Ralph Venter</h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0 comman-round">
                                                    <div class="icon"><img class="img-fluid"
                                                            src="{{ asset('admiro') }}/assets/images/dashboard-3/user/15.png"
                                                            alt="chair" /></div>
                                                </div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h5>Edwin Deo</h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0 comman-round">
                                                    <div class="icon"><img class="img-fluid"
                                                            src="{{ asset('admiro') }}/assets/images/dashboard-3/user/16.png"
                                                            alt="chair" /></div>
                                                </div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h5>Aaron Hors</h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0 comman-round">
                                                    <div class="icon"><img class="img-fluid"
                                                            src="{{ asset('admiro') }}/assets/images/dashboard-3/user/17.png"
                                                            alt="chair" /></div>
                                                </div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h5>Fenter Jessy</h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0 comman-round">
                                                    <div class="icon"><img class="img-fluid"
                                                            src="{{ asset('admiro') }}/assets/images/dashboard-3/user/18.png"
                                                            alt="chair" /></div>
                                                </div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h5>Alice Hogan</h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0 comman-round">
                                                    <div class="icon"><img class="img-fluid"
                                                            src="{{ asset('admiro') }}/assets/images/dashboard-3/user/19.png"
                                                            alt="chair" /></div>
                                                </div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h5>Aaron Hors</h5>
                ...
                <div class="card pie-card">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            ...
                            <div class="dropdown icon-dropdown">
                                <button class="btn" id="userdropdown8" type="button"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i
                                        class="fa-solid fa-ellipsis"></i></button>
                                <div class="dropdown-menu dropdown-menu-end"
                ...
                <div class="card">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            <h3>To-do list</h3>
                            <div class="dropdown icon-dropdown">
                                <button class="btn" id="userdropdown9" type="button"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i
                                        class="fa-solid fa-ellipsis"></i></button>
                                <div class="dropdown-menu dropdown-menu-end"
                    ...
                    <div class="card-body todo-list filled-checkbox">
                        <ul>
                            ...
                            <li class="d-flex line-secondary">
                                ...
                                <div class="flex-grow-1"><a href="task.html">
                                        <h5 class="f-w-500">Prepare for History exam</h5>
                                    </a>
                                    <h6>Complete english test</h6>
                            ...
                            <li class="d-flex line-danger">
                                <div class="flex-shrink-0">
                                    <div class="form-check checkbox checkbox-solid-primary">
                                        <input class="form-check-input" id="solid3"
                                            type="checkbox" />
                                        <label class="form-check-label" for="solid3"> </label>
                                    </div>
                                </div>
                                <div class="flex-grow-1"><a href="task.html">
                                        <h5 class="f-w-500">Finish Digital Art project</h5>
                                    </a>
                            ...
                            <li class="d-flex line-info">
                                <div class="flex-shrink-0">
                                    <div class="form-check checkbox checkbox-solid-primary">
                                        <input class="form-check-input" id="solid4"
                                            type="checkbox" />
                                        <label class="form-check-label" for="solid4"> </label>
                                    </div>
                                </div>
                                <div class="flex-grow-1"><a href="task.html">
                                        <h5 class="f-w-500">Write essay Honesty is....</h5>
                                    </a>
                            ...
                            <li class="d-flex line-secondary">
                                <div class="flex-shrink-0">
                                    <div class="form-check checkbox checkbox-solid-primary">
                                        <input class="form-check-input" id="solid5"
                                            type="checkbox" />
                                        <label class="form-check-label" for="solid5"> </label>
                                    </div>
                                </div>
                                <div class="flex-grow-1"><a href="task.html">
                                        <h5 class="f-w-500">Make Presentation</h5>
                                    </a>
                                    <h6>Complete english test</h6>
                            ...
                            <li class="d-flex line-warning">
                                <div class="flex-shrink-0">
                                    <div class="form-check checkbox checkbox-solid-primary">
                                        <input class="form-check-input" id="solid7"
                                            type="checkbox" />
            ...
            <div class="col-xxl-6 col-xl-7 order-xxl-0 order-xl-3 col-md-6 box-col-7 box-order-2">
                <div class="card">
                    ...
                    <div class="card-body pt-0 assignment-table">
                        <div class="table-responsive theme-scrollbar">
                            <table class="table display table-bordernone pt-0" id="assignment"
                                style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Customer</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="{{ asset('admiro') }}/assets/images/dashboard-3/user/1.png"
                                                        alt="" /></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h6>Gary Goodwin</h6>
                                                    </a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="{{ asset('admiro') }}/assets/images/dashboard-3/user/2.png"
                                                        alt="" /></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h6>Ralph Venter</h6>
                                                    </a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="{{ asset('admiro') }}/assets/images/dashboard-3/user/3.png"
                                                        alt="" /></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h6>Edwin Deo</h6>
                                                    </a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="{{ asset('admiro') }}/assets/images/dashboard-3/user/4.png"
                                                        alt="" /></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h6>Aaron Hors</h6>
                                                    </a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="{{ asset('admiro') }}/assets/images/dashboard-3/user/5.png"
                                                        alt="" /></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h6>Fenter Jessy</h6>
                                                    </a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="{{ asset('admiro') }}/assets/images/dashboard-3/user/6.png"
                                                        alt="" /></div>
                                                <div class="flex-grow-1"><a href="product-page.html">
                                                        <h6>Alice Hogan</h6>
                                                    </a>
                ...
                <div class="card overflow-hidden">
                    <div class="card-header card-no-border pb-0">
                        <div class="header-top">
                            ...
                            <div class="dropdown icon-dropdown">
                                <button class="btn" id="userdropdown02" type="button"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i
                                        class="fa-solid fa-ellipsis"></i></button>
                                <div class="dropdown-menu dropdown-menu-end"
