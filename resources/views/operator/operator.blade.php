                    ...
                    <div class="card-body">
                        <div class="mb-3 text-end">
                            ...
                            <button class="btn btn-pill btn-primary" type="button" data-bs-toggle="modal"
                                data-bs-target="#exampleModalgetbootstrap" title="Tambah Users">+Tambah Users</button>
                        </div>
                            ...
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    @foreach ($operator as $item)
                                            ...
                                            <td>
                                                <ul class="action">
                                                    <li class="edit" data-bs-toggle="modal"
                                                        data-bs-target="#exampleModalgetbootstrap{{ $item->id }}"><a
                                                            href="#"><i class="icon-pencil-alt"></i></a>
                                                    </li>
                                                    <li class="delete" data-bs-toggle="modal"
                                                        data-bs-target="#modalhapususers{{ $item->id }}"><a
                                                            href="#"><i class="icon-trash"></i></a></li>
                                                </ul>
                                            </td>
                                        </tr>
                                        {{-- modal hapus 2 --}}
                                        <div class="modal fade" id="modalhapususers{{ $item->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="modalTambahuserstLabel" aria-hidden="true">
                                                        ...
                                                        <div class="modal-toggle-wrapper">
                                                            ...
                                                            <div class="modal-body">
                                                                <p class="mt-2 text-center">
                                                                    Apakah anda yakin ingin menghapus Users:
                                                                </p>
                                                                <p class="text-center">
                                                                    <span
                                        ...
                                        {{-- modal edit --}}
                                        <div class="modal fade" id="exampleModalgetbootstrap{{ $item->id }}"
                                            tabindex="-1" aria-labelledby="exampleModalgetbootstrap" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header border-0">
                                                        <h5 class="modal-title mx-auto">Tambah Data users</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                                    <form action="/users/{{ $item->id }}/update" method="POST"
                                                            ...
                                                            <div class="row g-3">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="validationCustom01" name="nama"
                                                                        value="{{ $item->name}}"
                                                                        placeholder="Masukkan Nama users..." required>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-toggle-wrapper social-profile text-start dark-sign-up">
                    <h3 class="modal-header justify-content-center border-0">Tambah Data Users</h3>
                    <div class="modal-body">
                        <form action="/users/plus" method="POST" class="row g-3 needs-validation" novalidate="">
                            @csrf
                            <div class="col-md-6">
                                <label class="form-label" for="validationCustom01">Nama Users</label>
                                <input class="form-control" id="validationCustom01" type="text" name="nama"
                                    placeholder="Masukkan Nama users...." required="">
                                <div class="valid-feedback">Looks good!</div>
                            </div>
                            <div class="col-md-6">
