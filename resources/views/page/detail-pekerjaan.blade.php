    ...
    <section class="breadcrumb-area">
        <div class="container">
            <div class="breadcrumb-content" data-aos="fade-up">
                ...
                <h1 class="section-heading"><img src="{{ asset('pages') }}/assets/images/star-2.png" alt="Star">project
                    saya<img src="{{ asset('pages') }}/assets/images/star-2.png" alt="Star"></h1>
            </div>
        </div>
    </section>
    <section class="project-details-wrap">
        <div class="project-details-img" data-aos="zoom-in">
            <img src="{{ asset($project->foto_project) }}" alt="Project Details" class="img-fluid w-100"
                style="max-height: 551px; object-fit: cover;">
        </div>
            ...
            <div class="row mb-24">
                <div class="col-md-6" data-aos="zoom-in">
                    <div class="project-details-3-img">
                        <img src="{{ asset($project->foto_pages) }}" alt="Project">
                    </div>
                </div>
                <div class="col-md-6" data-aos="zoom-in">
                    <div class="project-details-3-img">
                        <img src="{{ asset($project->foto_dashboard) }}" alt="Project">
                    </div>
                </div>
            </div>
        </div>
