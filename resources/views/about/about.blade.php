                    ...
                    <div class="card-body">
                        <div class="mb-3 text-end">
                            ...
                            <button class="btn btn-pill btn-primary" type="button" data-bs-toggle="modal"
                                data-bs-target="#exampleModalgetbootstrap" title="Tambah about">+Tambah about</button>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($about as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->desk_about }}</td>
                                            <td>
                                                <ul class="action">
                                                    <li class="edit" data-bs-toggle="modal"
                                                        data-bs-target="#exampleModalgetbootstrap{{ $item->id_about }}"><a
                                                            href="#"><i class="icon-pencil-alt"></i></a>
                                                    </li>
                                                    <li class="delete" data-bs-toggle="modal"
                                                        data-bs-target="#modalhapusabout{{ $item->id_about }}"><a
                                                            href="#"><i class="icon-trash"></i></a></li>
                                                </ul>
                                            </td>
                                        </tr>
                                        {{-- modal hapus 2 --}}
                                        <div class="modal fade" id="modalhapusabout{{ $item->id_about }}" tabindex="-1"
                                            role="dialog" aria-labelledby="modalTambahaboutLabel" aria-hidden="true">
                                                        ...
                                                        <div class="modal-toggle-wrapper">
                                                            ...
                                                            <div class="modal-body">
                                                                <p class="mt-2 text-center">
                                                                    Apakah anda yakin ingin menghapus about:
                                                                </p>
                                                                <p class="text-center">
                                                                    <span
                                                            ...
                                                            <div class="d-flex justify-content-center gap-2">
                                                                ...
                                                                <a href="/hapus/{{ $item->id_about }}/about"
                                        ...
                                        {{-- modal edit --}}
                                        <div class="modal fade" id="exampleModalgetbootstrap{{ $item->id_about }}"
                                            tabindex="-1" aria-labelledby="exampleModalgetbootstrap" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header border-0">
                                                        <h5 class="modal-title mx-auto">Tambah Data about</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                                    <form action="/edit/{{ $item->id_about }}/about" method="POST"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row g-3">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <textarea class="form-control" name="desk" id="exampleFormControlTextarea1" rows="3"
                                                                        placeholder="Masukkan Description..." required>{{ $item->desk_about }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-toggle-wrapper social-profile text-start dark-sign-up">
                    <h3 class="modal-header justify-content-center border-0">Tambah Data about</h3>
                    <div class="modal-body">
                        <form action="/about-tambah" method="POST" class="row g-3 needs-validation" novalidate="">
                            @csrf
                            <div class="modal-body">
                                <div class="col-12">
